...
This fork is no longer maintained because the custom PUA glyph rendering issue has been fixed in the official Angelica 2.1.55 release.
...
* Shaders - Beta
   * Complementary + Euphoria Patches is the primary compatibility target
   * Sildurs, Seus, and any other shaders might work
...
This fork fixes GTNH Private Use Area glyph rendering when Angelica custom fonts are enabled.
...
* ClientFixer - Use a resource pack like [GTNH-FTI-Standard-Font](https://github.com/Eldrinn-Elantey/GTNH-FTI-Standard-Font)
