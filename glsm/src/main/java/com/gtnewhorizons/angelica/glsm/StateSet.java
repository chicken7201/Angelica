...
public final class StateSet {
    ...
    /** Preserves font draw state, including polygon offsets replayed by glyphfix text segments. */
    ...
    /** Preserves Iris font draw state, including glyphfix polygon-offset replay. */
